...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_courses_currency" AS ENUM('INR', 'USD', 'EUR', 'GBP');
  CREATE TYPE "public"."enum_courses_level" AS ENUM('beginner', 'intermediate', 'advanced', 'all');
  CREATE TYPE "public"."enum_courses_mode" AS ENUM('live', 'self-paced', 'hybrid');
  CREATE TYPE "public"."enum_courses_icon" AS ENUM('code', 'globe', 'chart', 'brain', 'cloud', 'smartphone', 'shield', 'database', 'palette');
  CREATE TYPE "public"."enum_courses_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__courses_v_version_currency" AS ENUM('INR', 'USD', 'EUR', 'GBP');
  CREATE TYPE "public"."enum__courses_v_version_level" AS ENUM('beginner', 'intermediate', 'advanced', 'all');
  CREATE TYPE "public"."enum__courses_v_version_mode" AS ENUM('live', 'self-paced', 'hybrid');
  CREATE TYPE "public"."enum__courses_v_version_icon" AS ENUM('code', 'globe', 'chart', 'brain', 'cloud', 'smartphone', 'shield', 'database', 'palette');
  CREATE TYPE "public"."enum__courses_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_enquiries_status" AS ENUM('new', 'contacted', 'enrolled', 'closed');
  CREATE TYPE "public"."enum_enrollments_provider" AS ENUM('razorpay', 'stripe');
  CREATE TYPE "public"."enum_enrollments_status" AS ENUM('pending', 'paid', 'failed', 'refunded');
  ...
  CREATE TABLE "courses_curriculum_lessons" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"lesson" varchar
  ...
  CREATE TABLE "courses" (
  	...
  	"meta_description" varchar,
  	"price" numeric,
  	"currency" "enum_courses_currency" DEFAULT 'INR',
  	"duration" varchar,
  	"level" "enum_courses_level" DEFAULT 'beginner',
  	"mode" "enum_courses_mode" DEFAULT 'live',
  	"icon" "enum_courses_icon" DEFAULT 'code',
  ...
  CREATE TABLE "_courses_v_version_curriculum_lessons" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"lesson" varchar,
  ...
  CREATE TABLE "_courses_v_version_curriculum" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"module_title" varchar,
  ...
  CREATE TABLE "_courses_v" (
  	...
  	"version_currency" "enum__courses_v_version_currency" DEFAULT 'INR',
  	"version_duration" varchar,
  	"version_level" "enum__courses_v_version_level" DEFAULT 'beginner',
  	"version_mode" "enum__courses_v_version_mode" DEFAULT 'live',
  	"version_icon" "enum__courses_v_version_icon" DEFAULT 'code',
  ...
  CREATE TABLE "enrollments" (
  	...
  	"provider" "enum_enrollments_provider",
  ...
  ALTER TABLE "courses_curriculum_lessons" ADD CONSTRAINT "courses_curriculum_lessons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."courses_curriculum"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_courses_v_version_curriculum_lessons" ADD CONSTRAINT "_courses_v_version_curriculum_lessons_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_courses_v_version_curriculum"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_courses_v_version_curriculum" ADD CONSTRAINT "_courses_v_version_curriculum_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_courses_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "courses_curriculum_lessons_order_idx" ON "courses_curriculum_lessons" USING btree ("_order");
  CREATE INDEX "courses_curriculum_lessons_parent_id_idx" ON "courses_curriculum_lessons" USING btree ("_parent_id");
  ...
  CREATE INDEX "_courses_v_version_curriculum_lessons_order_idx" ON "_courses_v_version_curriculum_lessons" USING btree ("_order");
  CREATE INDEX "_courses_v_version_curriculum_lessons_parent_id_idx" ON "_courses_v_version_curriculum_lessons" USING btree ("_parent_id");
  CREATE INDEX "_courses_v_version_curriculum_order_idx" ON "_courses_v_version_curriculum" USING btree ("_order");
  CREATE INDEX "_courses_v_version_curriculum_parent_id_idx" ON "_courses_v_version_curriculum" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "courses_curriculum_lessons" CASCADE;
  DROP TABLE "courses_curriculum" CASCADE;
  DROP TABLE "courses_outcomes" CASCADE;
  DROP TABLE "courses" CASCADE;
  DROP TABLE "courses_rels" CASCADE;
  DROP TABLE "_courses_v_version_curriculum_lessons" CASCADE;
  DROP TABLE "_courses_v_version_curriculum" CASCADE;
  ...
  DROP TYPE "public"."enum_courses_mode";
  DROP TYPE "public"."enum_courses_icon";
  DROP TYPE "public"."enum_courses_status";
  DROP TYPE "public"."enum__courses_v_version_currency";
  DROP TYPE "public"."enum__courses_v_version_level";
  DROP TYPE "public"."enum__courses_v_version_mode";
  DROP TYPE "public"."enum__courses_v_version_icon";
  DROP TYPE "public"."enum__courses_v_version_status";
  DROP TYPE "public"."enum_enquiries_status";
  DROP TYPE "public"."enum_enrollments_provider";
