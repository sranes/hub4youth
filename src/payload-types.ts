...
export interface Course {
  ...
  title: string;
  /**
   * One- or two-line description shown on course cards.
   */
  summary: string;
  heroImage?: (number | null) | Media;
  content?: {
  ...
  /**
   * Break the course into modules; each lists its topics.
   */
  curriculum?:
    | {
        moduleTitle: string;
  ...
  /**
   * Enrollment price. Use 0 for free courses.
   */
  price: number;
  ...
  mode?: ('live' | 'self-paced' | 'hybrid') | null;
  /**
   * Icon shown on the course card.
   */
  icon?: ('code' | 'globe' | 'chart' | 'brain' | 'cloud' | 'smartphone' | 'shield' | 'database' | 'palette') | null;
  /**
...
export interface Enquiry {
  ...
  phone?: string | null;
  /**
   * Course the enquiry is about, if any.
   */
  course?: string | null;
  message?: string | null;
...
export interface Enrollment {
  ...
  phone?: string | null;
  /**
   * Charged amount in the major currency unit (e.g. rupees, not paise).
   */
  amount: number;
  ...
  /**
   * Payment id confirmed by the provider webhook.
   */
